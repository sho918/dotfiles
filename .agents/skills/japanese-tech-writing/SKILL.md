...
description: Use when Codex writes, edits, rewrites, or reviews Japanese technical documents, book drafts, articles, explanations, or agent-generated prose; especially for one-sentence-per-line formatting, paragraph writing, argument rigor, reader load, tone, restrained rhetoric, headings, avoiding LLM-like filler, and removing redundancy.
---
